...
const contractAddress = "0x517AEa509261230B4b006044e399A3EA1E9AF2A9";
...
const dApp = {
  ...
  main: async function () {
    ...
    this.marsJson = await (await fetch("./WineMarket.json")).json();
    this.auctionJson = await (await fetch("./WineAuction.json")).json();
